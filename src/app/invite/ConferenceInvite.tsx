    ...
    <main className="pt-20">
            ...
            <div className="relative aspect-[3/4] bg-[#2d3449] shadow-[0_40px_80px_rgba(0,0,0,0.6)] border border-[#434656]/15 overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-[#0b1326]/90 to-transparent">
                <div className="flex justify-between items-end">
                  <div>
                    <p className="font-headline text-[10px] uppercase tracking-widest text-[#b8c3ff]">Location</p>
                    <p className="font-headline font-bold text-xl">The Monolith, NYC</p>
                  </div>
                  <div className="text-right">
                    <p className="font-headline text-[10px] uppercase tracking-widest text-[#b8c3ff]">Date</p>
                    <p className="font-headline font-bold text-xl">Nov 24-26</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-8 bg-[#060e20]">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Session Q&A */}
          <div className="group relative overflow-hidden bg-[#171f33] border border-[#434656]/10 p-10 h-64 flex flex-col justify-between hover:bg-[#31394d] transition-colors duration-500 cursor-pointer">
            ...
            <div>
              <h3 className="font-headline font-bold text-2xl mb-2">Session Q&A</h3>
              <p className="text-[#c4c5d9] text-sm mb-6 max-w-xs">
                Drop a voice message to the keynote speakers before the event starts.
              </p>
              <button className="flex items-center gap-2 font-headline text-xs uppercase tracking-widest font-bold text-[#b8c3ff] group-hover:gap-4 transition-all bg-transparent border-none cursor-pointer p-0">
          ...
          <div className="group relative overflow-hidden bg-[#171f33] border border-[#434656]/10 p-10 h-64 flex flex-col justify-between hover:bg-[#31394d] transition-colors duration-500 cursor-pointer">
            ...
            <div>
              <h3 className="font-headline font-bold text-2xl mb-2">Attendee Networking</h3>
              <p className="text-[#c4c5d9] text-sm mb-6 max-w-xs">
                Take a selfie to join the digital attendee mural and find your peers.
              </p>
              <button className="flex items-center gap-2 font-headline text-xs uppercase tracking-widest font-bold text-[#4edea3] group-hover:gap-4 transition-all bg-transparent border-none cursor-pointer p-0">
